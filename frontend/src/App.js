...
const translations = {
    ...
    price: '0.99€',
    errorPayment: 'Maksun käsittely epäonnistui. Tarkista että täytit kaikki kentät ja yritä uudelleen.',
  ...
  en: {
    ...
    price: '0.99€',
    errorPayment: 'Payment processing failed. Make sure you have filled all fields and try again.',
